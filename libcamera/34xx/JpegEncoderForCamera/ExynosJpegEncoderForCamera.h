...
public :
    ...
    void setExtScalerNum(int csc_hwscaler_id) { m_ScalerID = csc_hwscaler_id; }
...
private:
protected:
    typedef ExynosCameraThread<ExynosJpegEncoderForCamera> MJpegThread;
    sp<MJpegThread>            m_JpegMainEncodeThread;

    virtual bool            m_JpegMainEncodeThreadFunc(void);
